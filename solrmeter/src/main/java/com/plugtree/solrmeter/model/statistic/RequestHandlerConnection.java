...
public class RequestHandlerConnection extends AbstractStatisticConnection {
	...
	public RequestHandlerConnection() {
		this(SolrServerRegistry.getSolrServer(SolrMeterConfiguration
				.getProperty(SolrMeterConfiguration.SOLR_SEARCH_URL)));
	}
	...
	private CacheData getCacheData(NamedList<Object> namedList, String cacheName) {
		...
		//		return new CacheData((Long) stats.get("lookups"), (Long) stats.get("hits"), Float.valueOf((String) stats
		//				.get("hitratio")), (Long) stats.get("inserts"), (Long) stats.get("evictions"), Long.valueOf(stats.get(
		//				"size").toString()), (Long) stats.get("warmupTime"));
		return new CacheData((Long) stats.get("lookups"), (Long) stats.get("hits"), (Float) stats.get("hitratio"),
				(Long) stats.get("inserts"), (Long) stats.get("evictions"), Long.valueOf(stats.get("size").toString()),
				(Long) stats.get("warmupTime"));
	}

	@SuppressWarnings("unchecked")
	private NamedList<Object> getCacheNamedList(NamedList<Object> namedList, String cacheName) {
		NamedList<Object> cache = ((NamedList<Object>) ((NamedList<Object>) ((NamedList<Object>) namedList
				.get("solr-mbeans")).get("CACHE")).get(cacheName));
		return cache;
	}
	...
	private CacheData getCumulativeCacheData(NamedList<Object> namedList, String cacheName) {
		...
		NamedList<Object> stats = (NamedList<Object>) cache.get("stats");
		//		return new CacheData((Long) stats.get("cumulative_lookups"), (Long) stats.get("cumulative_hits"),
		//				Float.valueOf((String) stats.get("cumulative_hitratio")), (Long) stats.get("cumulative_inserts"),
		//				(Long) stats.get("cumulative_evictions"));
		return new CacheData((Long) stats.get("cumulative_lookups"), (Long) stats.get("cumulative_hits"),
				(Float) stats.get("cumulative_hitratio"), (Long) stats.get("cumulative_inserts"),
				(Long) stats.get("cumulative_evictions"));
	}
